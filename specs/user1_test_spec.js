...
describe('One User - Test GraphQL USER API queries', function () {
...
//Posts
    ...
    it('A_ZESTY_USER-001 :Update User api', function (done) {
    ...
    it('A_ZESTY_USER-002 :Add User to Stripe api', function (done) {
    ...
    it('A_ZESTY_USER-003 :Add User Payment api', function (done) {
    ...
    it('A_ZESTY_USER-004 :User Payment method api', function (done) {
    ...
    it('A_ZESTY_USER-005 :Update User Payment api', function (done) {
...
//Chef
     ...
     it('A_ZESTY_CHEF-006 :Create Candidate api', function (done) {
     ...
     it('A_ZESTY_CHEF-007 :Create Chef api', function (done) {
     ...
     it('A_ZESTY_CHEF-008 :Get Chef api', function (done) {
     ...
     it('A_ZESTY_CHEF-009 :Add Chef Payout api', function (done) {
     ...
     it('A_ZESTY_CHEF-010 :Update Chef Payout api', function (done) {
     ...
     it('A_ZESTY_CHEF-011 :Chef Payout Method api', function (done) {
     ...
     it('A_ZESTY_CHEF-012 :Update Chef api', function (done) {
     ...
     it('A_ZESTY_CHEF-013 :Get Chef api', function (done) {
     ...
     it('A_ZESTY_CHEF-014 :Featured Chef api', function (done) {
     ...
     it('A_ZESTY_CHEF-015 :Find Chef api', function (done) {
     ...
     it('A_ZESTY_CHEF-016 :List Chef Transactions api', function (done) {
     ...
     it('A_ZESTY_CHEF-017 :Chef By Dish api', function (done) {
...
//Dish
    ...
    it('A_ZESTY_DISHES-018 : Create Dish api', function (done) {
    ...
    it('A_ZESTY_DISHES-019 : Calculate Price api', function (done) {
    ...
    it('A_ZESTY_DISHES-020 : Cuisine api', function (done) {
    ...
    it('A_ZESTY_DISHES-021 : Dishes List api', function (done) {
    ...
    it('A_ZESTY_DISHES-022 : Get Available Dishes api', function (done) {
    ...
    it('A_ZESTY_DISHES-023 : User Liked Dish api', function (done) {
    ...
    it('A_ZESTY_DISHES-024 : Dish api', function (done) {
    ...
    it('A_ZESTY_DISHES-025 : Dishes By Chef api', function (done) {
    ...
    it('A_ZESTY_DISHES-026 : Featured Dishes api', function (done) {
    ...
    it('A_ZESTY_DISHES-027 : Find Dishes api', function (done) {
    ...
    it('A_ZESTY_DISHES-028 : Update Dish api', function (done) {
    ...
    it('A_ZESTY_DISHES-029 : Re-Test After Updation Dish api', function (done) {
    ...
    it('A_ZESTY_DISHES-030 : Dishes By Chef api', function (done) {
...
//Bookings
     ...
     it('A_ZESTY_BOOKINGS-031 : Reserve Chef Slot api', function (done) {
     ...
     it('A_ZESTY_BOOKINGS-032 : Create In Progress Booking api', function (done) {
     ...
     it('A_ZESTY_BOOKINGS-033 : Update In Progress Booking api', function (done) {
     ...
     it('A_ZESTY_BOOKINGS-034 : Create Booking api', function (done) {
     ...
     it('A_ZESTY_BOOKINGS-035 : Mark Booking As Complete Api ', function (done) {
     ...
     it('A_ZESTY_BOOKINGS-036 : Chef Booking api', function (done) {
     ...
     it('A_ZESTY_BOOKINGS-037 : User Booking api', function (done) {
...
//Posts
      ...
      it('A_ZESTY_POST-038 :Create Post api', function (done) {
      ...
      it('A_ZESTY_POST-039 :Get Post By ID api', function (done) {
      ...
      it('A_ZESTY_POST-040 :Featured Post api', function (done) {
      ...
      it('A_ZESTY_POST-041 :User Like Post api', function (done) {
      ...
      it('A_ZESTY_POST-042 :Posts api', function (done) {
      ...
      it('A_ZESTY_POST-043 :Update Post api', function (done) {
      ...
      it('A_ZESTY_POST-044 :Calling Get Post After Update api', function (done) {
